...
void embaralhar(int baralho1[24], int baralho2[24])
{
    ...
    for(int i=0; i<12; i++)// Divisão das posições do baralho principal entre os dos jogadores//
    {
...
int vitoria1(int baralho1[24], int baralho2[24], int mesa[24], int contador_jogador[3], int vez_jogador)
{
    ...
    contador_jogador[1] --;
    int j = 0;
    while(j<contador_jogador[0])//arruma as posições das cartas nos baralhos após uma rodada//
    {
        baralho1[j] = baralho1[j+1];
        j++;
    }
    j = 0;
    while (j < contador_jogador[1])//arruma as posições das cartas nos baralhos após uma rodada//
    {
        baralho2[j] =  baralho2[j+1];
        j++;
    }
    vez_jogador = 1;//define o jogador da vez//
    if(contador_jogador[2]>0)//se tiver cartas na mesa, joga elas pro baralho vencedor//
    {
...
int vitoria2(int baralho1[24], int baralho2[24], int mesa[24], int contador_jogador[3], int vez_jogador)
{
    ...
    contador_jogador[0] --;
    int j = 0;
    while(j < contador_jogador[0])//arrunma as posições das cartas//
    {
        baralho1[j] = baralho1[j+1];
        j++;
    }
    j = 0;
    while(j < contador_jogador[1])//arruma as posições das cartas//
    {
        baralho2[j] = baralho2[j+1];
        j++;
    }
    vez_jogador = 0;//define o jogador da vez//
    if (contador_jogador[2] > 0)//se tiver cartas na mesa atribui elas ao baralho ganhador da rodada//
    {
        while (contador_jogador[2] > 0)
        {
...
int empate(int baralho1[24], int baralho2[24], int mesa[24], int contador_jogador[3], int vez_jogador)
{
    ...
    contador_jogador[2]++;
    int j = 0;
    while (j < contador_jogador[0])//arruma as posições dos baralhos//
    {
        baralho1[j] = baralho1[j+1];
        j++;
    }
        ...
        {   
            ...
            if (card[baralho1[0]].attack > card[baralho1[0]].defense && card[baralho1[0]].attack > card[baralho1[0]].stamina )
            {
                if (card[baralho2[0]].supertrunfo == 1)//testa se o jogador 2 tem carta super trunfo na vez do jogador 1//
                {
                    if (card[baralho1[0]].type ==  'A')//testa se jogador 1 tem carta tipo A//
                    {
                        ...
                        if (contador_jogador[0] == 24)//se jogador que venceu tem 24 cartas ele ganha o jogo//
                            {
                    ...
                    else //situação caso adversario tenha super trunfo e o jogador da vez não tenha carta tipo A//
                    {
                        ...
                        if (contador_jogador[1] == 24)//se jogador que venceu tem 24 cartas ele ganha o jogo//
                            {
            ...
            */
            else if (card[baralho1[0]].defense > card[baralho1[0]].attack && card[baralho1[0]].defense > card[baralho1[0]].stamina )
            {
                ...
                //testa se o jogador da vez tem carta super trunfo//
                else if (card[baralho1[0]].supertrunfo == 1)
                {
                ...
                else if (card[baralho2[0]].defense > card[baralho1[0]].defense)//defesa do jogador 2 é maior que defesa do jogadorm 1//
                {
                    printf("jogador 1: eu tenho:");
                    puts(card[baralho1[0]].nomecarta);
                    printf("jogador 2: eu tenho:");
            ...
            */
            ...
            {
                //testa se jogador 2 tem carta super trunfo na vez do jogador 1//
                if (card[baralho2[0]].supertrunfo == 1)
                {
